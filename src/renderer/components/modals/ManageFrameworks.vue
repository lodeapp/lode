...
<template>
    <Modal :key="repository.id" :title="singleFramework ? 'Framework Settings' : 'Manage test frameworks'">
        <div class="fluid">
            <div class="repository-settings">
                <h5 v-if="!singleFramework">
                    ...
                    <button type="button" class="btn btn-sm" :disabled="scanning" @click="handleScan">
                        Scan for frameworks
                    </button>
                </h5>
