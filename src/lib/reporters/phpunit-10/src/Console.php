...
class Console
{
     ...
     */
    private function write($vars, $dump = true): void
    {
        try {
            $context = [];
     ...
     */
    private function writeToLog(array $context, $log, $render = 'string'): void
    {
     ...
     */
    public function pullTestLogs(string $filename, string $test): array
    {
     ...
     */
    public function pullSuiteLogs(string $filename): array
    {
